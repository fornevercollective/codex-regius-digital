# Marginalia, Doodles & Surface Analysis — Page 3

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_3.png`
...
|----|--------|------|-------------|----------------|
| M-003-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-003-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-003-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
