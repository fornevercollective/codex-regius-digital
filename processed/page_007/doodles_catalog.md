# Marginalia, Doodles & Surface Analysis — Page 7

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_7.png`
...
|----|--------|------|-------------|----------------|
| M-007-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-007-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-007-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
