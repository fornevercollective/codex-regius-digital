# Marginalia, Doodles & Surface Analysis — Page 11

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_11.png`
...
|----|--------|------|-------------|----------------|
| M-011-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-011-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-011-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
