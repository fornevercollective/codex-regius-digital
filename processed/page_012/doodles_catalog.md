# Marginalia, Doodles & Surface Analysis — Page 12

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_12.png`
...
|----|--------|------|-------------|----------------|
| M-012-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-012-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-012-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
