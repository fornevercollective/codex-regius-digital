...
**Generated**: 2026-06-29T02:58:29.920842+00:00

## Pipeline Steps
- **preprocess** (ok): [{'step': '01_raw_gray', 'note': 'Grayscale load', 'shape': [2394, 1596]}, {'step': '02_denoised', 'note': 'Non-local means denoise', 'shape': [2394, 1596]}, {'step': '03_contrast', 'note': 'CLAHE contrast', 'shape': [2394, 1596]}, {'step': '04_binarized', 'note': 'Otsu binarization', 'shape': [2394, 1596]}, {'step': '05_deskewed', 'note': 'Deskew correction (0.00°)', 'shape': [2394, 1596]}]
- **ocr** (ok): Tesseract extraction complete
- **ocr_to_assessment** (ok): ["'Ek' → 'ek'"]

## Image Metrics (ML)
- **artistic_vellum**: SSIM=0.99, contrast Δ=1.3
- **clean_white**: SSIM=0.696, contrast Δ=38.8
- **grok_artistic_vellum**: SSIM=0.4415, contrast Δ=14.8
- **grok_clean_white**: SSIM=0.2755, contrast Δ=30.5
...
- [WARNING] **UNUSUAL_CHARS**: Line 28: unusual characters detected.
  - Suggestion: `Compare glyph-by-glyph with raw scan.`
- [WARNING] **UNUSUAL_CHARS**: Line 40: unusual characters detected.
  - Suggestion: `Compare glyph-by-glyph with raw scan.`
