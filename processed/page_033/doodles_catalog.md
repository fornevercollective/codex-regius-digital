# Marginalia, Doodles & Surface Analysis — Page 33

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_33.png`
...
|----|--------|------|-------------|----------------|
| M-033-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-033-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-033-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
