# Marginalia, Doodles & Surface Analysis — Page 40

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_40.png`
...
|----|--------|------|-------------|----------------|
| M-040-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-040-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-040-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
