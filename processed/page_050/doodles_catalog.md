# Marginalia, Doodles & Surface Analysis — Page 50

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_50.png`
...
|----|--------|------|-------------|----------------|
| M-050-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-050-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-050-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
