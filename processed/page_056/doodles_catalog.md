# Marginalia, Doodles & Surface Analysis — Page 56

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_56.png`
...
|----|--------|------|-------------|----------------|
| M-056-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-056-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-056-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
