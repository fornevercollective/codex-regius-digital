# Marginalia, Doodles & Surface Analysis — Page 60

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_60.png`
...
|----|--------|------|-------------|----------------|
| M-060-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-060-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-060-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
