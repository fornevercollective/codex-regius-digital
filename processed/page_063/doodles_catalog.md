# Marginalia, Doodles & Surface Analysis — Page 63

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_63.png`
...
|----|--------|------|-------------|----------------|
| M-063-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-063-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-063-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
