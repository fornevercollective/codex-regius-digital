# Marginalia, Doodles & Surface Analysis — Page 64

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_64.png`
...
|----|--------|------|-------------|----------------|
| M-064-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-064-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-064-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
