# Marginalia, Doodles & Surface Analysis — Page 65

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_65.png`
...
|----|--------|------|-------------|----------------|
| M-065-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-065-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-065-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
...
| 10 | uncertain_reading | Editorial uncertainty mark |
