# Marginalia, Doodles & Surface Analysis — Page 67

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_67.png`
...
|----|--------|------|-------------|----------------|
| M-067-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-067-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-067-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
