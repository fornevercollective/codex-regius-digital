# Marginalia, Doodles & Surface Analysis — Page 70

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_70.png`
...
|----|--------|------|-------------|----------------|
| M-070-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-070-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-070-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |

## Misprints & Scribal Corrections
| Line | Type | Note |
|------|------|------|
| 2 | uncertain_reading | Editorial uncertainty mark |
