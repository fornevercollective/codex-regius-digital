# Marginalia, Doodles & Surface Analysis — Page 75

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_75.png`
...
|----|--------|------|-------------|----------------|
| M-075-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-075-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-075-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
