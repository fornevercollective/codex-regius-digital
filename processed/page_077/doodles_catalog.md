# Marginalia, Doodles & Surface Analysis — Page 77

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_77.png`
...
|----|--------|------|-------------|----------------|
| M-077-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-077-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-077-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
