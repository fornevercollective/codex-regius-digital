# Marginalia, Doodles & Surface Analysis — Page 78

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_78.png`
...
|----|--------|------|-------------|----------------|
| M-078-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-078-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-078-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
