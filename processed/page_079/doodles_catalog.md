# Marginalia, Doodles & Surface Analysis — Page 79

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_79.png`
...
|----|--------|------|-------------|----------------|
| M-079-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-079-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-079-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
