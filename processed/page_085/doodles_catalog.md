# Marginalia, Doodles & Surface Analysis — Page 85

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_85.png`
...
|----|--------|------|-------------|----------------|
| M-085-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-085-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-085-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
