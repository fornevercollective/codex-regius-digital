# Marginalia, Doodles & Surface Analysis — Page 86

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_86.png`
...
|----|--------|------|-------------|----------------|
| M-086-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-086-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-086-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
