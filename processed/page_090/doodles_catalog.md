# Marginalia, Doodles & Surface Analysis — Page 90

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_90.png`
...
|----|--------|------|-------------|----------------|
| M-090-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-090-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-090-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
