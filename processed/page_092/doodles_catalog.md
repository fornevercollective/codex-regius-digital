# Marginalia, Doodles & Surface Analysis — Page 92

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_92.png`
...
|----|--------|------|-------------|----------------|
| M-092-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-092-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-092-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
