# Marginalia, Doodles & Surface Analysis — Page 93

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_93.png`
...
|----|--------|------|-------------|----------------|
| M-093-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-093-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-093-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
