# Marginalia, Doodles & Surface Analysis — Page 97

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_97.png`
...
|----|--------|------|-------------|----------------|
| M-097-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-097-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-097-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
