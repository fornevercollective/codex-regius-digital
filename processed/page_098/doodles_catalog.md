# Marginalia, Doodles & Surface Analysis — Page 98

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_98.png`
...
|----|--------|------|-------------|----------------|
| M-098-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-098-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-098-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
