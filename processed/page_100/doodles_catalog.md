# Marginalia, Doodles & Surface Analysis — Page 100

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_100.png`
...
|----|--------|------|-------------|----------------|
| M-100-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-100-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-100-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
