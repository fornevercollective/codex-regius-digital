# Marginalia, Doodles & Surface Analysis — Page 102

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_102.png`
...
|----|--------|------|-------------|----------------|
| M-102-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-102-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-102-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
