# Marginalia, Doodles & Surface Analysis — Page 104

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_104.png`
...
|----|--------|------|-------------|----------------|
| M-104-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-104-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-104-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |

## Misprints & Scribal Corrections
| Line | Type | Note |
|------|------|------|
| — | — | None auto-detected; manual paleographic pass recommended |
