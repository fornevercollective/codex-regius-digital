# Marginalia, Doodles & Surface Analysis — Page 112

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_112.png`
...
|----|--------|------|-------------|----------------|
| M-112-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-112-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-112-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
