# Marginalia, Doodles & Surface Analysis — Page 118

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_118.png`
...
|----|--------|------|-------------|----------------|
| M-118-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-118-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-118-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
