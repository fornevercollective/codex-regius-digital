# Marginalia, Doodles & Surface Analysis — Page 119

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_119.png`
...
|----|--------|------|-------------|----------------|
| M-119-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-119-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-119-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
...
| 16 | uncertain_reading | Editorial uncertainty mark |
