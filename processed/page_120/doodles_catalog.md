# Marginalia, Doodles & Surface Analysis — Page 120

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_120.png`
...
|----|--------|------|-------------|----------------|
| M-120-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-120-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-120-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
