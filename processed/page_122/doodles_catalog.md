# Marginalia, Doodles & Surface Analysis — Page 122

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_122.png`
...
|----|--------|------|-------------|----------------|
| M-122-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-122-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-122-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
