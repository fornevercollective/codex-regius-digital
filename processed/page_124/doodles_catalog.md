# Marginalia, Doodles & Surface Analysis — Page 124

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_124.png`
...
|----|--------|------|-------------|----------------|
| M-124-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-124-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-124-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
...
| 12 | uncertain_reading | Editorial uncertainty mark |
