# Marginalia, Doodles & Surface Analysis — Page 126

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_126.png`
...
|----|--------|------|-------------|----------------|
| M-126-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-126-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-126-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
