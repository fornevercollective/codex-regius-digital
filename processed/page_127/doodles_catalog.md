# Marginalia, Doodles & Surface Analysis — Page 127

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_127.png`
...
|----|--------|------|-------------|----------------|
| M-127-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-127-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-127-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
