# Marginalia, Doodles & Surface Analysis — Page 128

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_128.png`
...
|----|--------|------|-------------|----------------|
| M-128-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-128-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-128-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
