# Marginalia, Doodles & Surface Analysis — Page 132

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_132.png`
...
|----|--------|------|-------------|----------------|
| M-132-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-132-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-132-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
