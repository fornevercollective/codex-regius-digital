# Marginalia, Doodles & Surface Analysis — Page 134

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_134.png`
...
|----|--------|------|-------------|----------------|
| M-134-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-134-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-134-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
