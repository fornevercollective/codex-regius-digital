# Marginalia, Doodles & Surface Analysis — Page 143

**Manuscript**: GKS 2365 4to
**Source**: `GKS2365_page_143.png`
...
|----|--------|------|-------------|----------------|
| M-143-01 | margin | pending | Visual survey required | Cross-ref. grok_variations/ |
| M-143-02 | text block | scratch | Hair-side abrasion check | Compare raw vs clean_white |
| M-143-03 | lower margin | doodle | [pending identification] | Animal/face/pen trial? |
