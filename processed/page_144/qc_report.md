...
**Generated**: 2026-06-29T04:38:57.381669+00:00
...
## Image Metrics (ML)
- **artistic_vellum**: SSIM=0.9716, contrast Δ=-3.0
- **clean_white**: SSIM=0.8992, contrast Δ=12.7
- **grok_artistic_vellum**: SSIM=0.3167, contrast Δ=-34.0
- **grok_clean_white**: SSIM=0.5455, contrast Δ=1.7
...
- [WARNING] **UNUSUAL_CHARS**: Line 7: unusual characters detected.
  - Suggestion: `Compare glyph-by-glyph with raw scan.`
- [ERROR] **DIGIT_NOISE**: Line 8: high digit ratio — likely OCR noise.
